...
const val FAILED_TO_CONNECT = "Failed to connect database"
const val FAILED_AUTHENTICATION = "Gagal login, silahkan periksa kembali email dan password anda"
const val FAILED_REGISTRATION = "Gagal mendaftarkan akun !"
const val FAILED_TO_INSERT = "Failed to insert user"
const val FAILED_UPLOAD_IMAGE = "Failed to uplaod image"
